...
const routes = [
  ...
  { path: '/wachtwoord-vergeten', name: 'forgot-password', component: () => import('../views/ForgotPasswordView.vue') },
  { path: '/wachtwoord-resetten', name: 'reset-password', component: () => import('../views/ResetPasswordView.vue') },
    ...
    component: () => import('../views/PortalView.vue') },
  {
    ...
    children: [
      ...
      { path: 'service-addons', name: 'admin-service-addons', component: () => import('../views/admin/AdminServiceAddons.vue') },
      ...
      { path: 'account', name: 'admin-account', component: () => import('../views/admin/AdminAccount.vue') },
    ],
  },
